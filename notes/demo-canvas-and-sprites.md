...
<ul>
	...
	5) Move the JS code to 4 separate files (named **src/utils.js**, **src/canvas-utils.js**, **src/sprites.js**,     **src/main.js**) and link to them via multiple `<script>` tags. Hint: Lo 
