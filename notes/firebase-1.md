...
- Open the page in a browser and check the console - you should see a log - something like:
  - `FirebaseAppImpl {_isDeleted: false, _options: {…}, _config: {…}, _name: '[DEFAULT]', _automaticDataCollectionEnabled: true, …}`
...
```js
import { getDatabase, ref, set, push, onValue } from  "https://www.gstatic.com/firebasejs/12.12.0/firebase-database.js";
```
