...
- Using our random joke app as a start file:
    ...
    - Hints:
      ...
      - PS - if you ever get any CORS issues on thios or another assignment, to fix the issue, use a proxy server like we did when we covered [PHP-driven JSON Web Service](./demo-php-web-service-json.md) last week - here it the URL to the service again: https://cors-anywhere.herokuapp.com/
