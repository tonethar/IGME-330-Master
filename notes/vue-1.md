...
[Vue.js](https://vuejs.org) is a JavaScript framework for building user interfaces.
 ...
 - it uses two-way *data binding* (see [Wikipedia - UI_data_binding](https://en.wikipedia.org/wiki/UI_data_binding) to *bind* (for example) &lt;input> values to backing variables, and the value of the backing variable to the &lt;input> value
