...
13. Move the rest of the code (minus the Iffy) into a file named `main.js` and create a &lt;script> element for it in the HTML file like we did for the other two modules
