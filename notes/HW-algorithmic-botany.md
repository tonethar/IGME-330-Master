...
6. `c` is a "script scoped" variable - go declare and initialize it now:
   ...
   - N.B. - `c` is the "constant scaling parameter" mentioned in the paper above - it's basically the *padding* between the florets (later on, changing this value or slowly increasing it gives interesting results)
