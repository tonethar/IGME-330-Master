...
- ***Note:  `npm link` will likely fail on the lab machines :-(  this won't hurt your HW grade because we will be looking for the `bin` key in package.json to verify that you at least tried to get it to work***
