...
3) In order to use these audio functions, you'll need to import them into **main.js**:

`import * as audio from './audio.js';`

4) Now add this line of code to the top of `main.init()`

`audio.setupWebaudio(DEFAULTS.sound1);`

5) Reload the page, and let's use the debugger to be sure everything is loading as it is supposed to
