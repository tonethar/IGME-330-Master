...
- The major disadvantage of using 3rd party frameworks to design web sites are:
  ...
  - most of these frameworks are dependant on 3rd party tooling to transform the HTML/CSS/JS from the framework's proprietary syntax (for example, React's JSX), into a form that the browser can understand
