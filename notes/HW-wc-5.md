...
- Get all of the above working for `colorList` - both the "Add" and "Clear" buttons - and the updating of the list component and `#output-text`
- N.B. - You don't need to write any code for `movieList`
