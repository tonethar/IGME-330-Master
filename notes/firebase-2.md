...
- You should now see these changes in the firebase console, where each score object has a *key* that is auto-generated by firebase (BTW, we are showing the old Firebase UI in these screenshots, yours will be different):
